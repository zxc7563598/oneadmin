    ...
    <div class="m-auto max-w-700 min-w-345 f-c-c rounded-8 auto-bg bg-opacity-20 bg-cover p-12 card-shadow">
      ...
      <div class="w-320 flex-col px-20 py-32">
        ...
        <div class="mt-20 flex items-center">
          <n-input
            v-model:value="loginInfo.captcha" class="h-40 items-center" palceholder="请输入验证码" :maxlength="4"
          ...
          <img
            v-if="captchaUrl" :src="captchaUrl" alt="验证码" height="40" class="ml-12 w-80 cursor-pointer"
            @click="initCaptcha"
          >
        </div>
...
const initCaptcha = throttle(() => {
  captchaUrl.value = 'https://m1.apifoxmock.com/m1/3776410-3408296-default/auth/captcha?1774611136160'
}, 500)
